<template class="bg-light">
  ...
  <div id="app" class="bg-light">
    ...
    <!-- <link rel="stylesheet" type="text/css" href="style.css"> -->
            ...
            <input v-on:input="fetchFilteredLessons" class="form-control w-auto " type="text" style="background: none;"  id="searchinput" v-model="inputSearch" placeholder="Search" />

            <h6 style="font-family: Poppins;  margin-top: 5px; margin-right: 10px;" >Sort:</h6>
          <select v-on:change="reorderList" v-model="items_order"  class="form-select w-auto " aria-label="Default select example">
        ...
        <div v-if="showLessons" class="bg-light" >
            ...
            <div  class="checkoutPage" v-else  style="color: white; flex-direction: column; justify-content: center; display: flex; align-items: center; font-family: Poppins; " >
                ...
                <div class="bg-light" v-else style="color: white; flex-direction: column; align-items: center; display: flex; margin-top: 30px; height:530px;  font-family: Poppins;">
                      Cart is Empty
...
export default {
  ...
  methods: {
    ...
    addLessonToCart(lesson) {
      console.log("add Lesson event received by the root component.");
