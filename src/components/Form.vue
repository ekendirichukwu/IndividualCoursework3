<template class="bg-light">
     ...
     <div class="bg-white" >
        ...
        <div class="card shadow p-3 mb-5 bg-white text-dark rounded" style="width: 40rem; margin-left: 15px; font-family: Poppins; "  >
    ...
    <!-- Checkout Form -->
        <div class="checkoutForm text-dark">
            ...
            <!-- Name input field -->
             ...
             <label for="name"  class="form-label">Name</label>
                <input type="text" v-model="name"  class="form-control" style="background: none;"  placeholder="Enter Name..." v-on:keypress="isLetter($event)">
             </div>
            
            <!-- Phone number field -->
             <div class="mb-3">
             <label for="phoneno"  class="form-label">Phone Number</label>
                <input type="text" v-model="phone"  class="form-control" style="background: none;" placeholder="0123" v-on:keypress="isNumber($event)"> <p></p>
             </div>            
    ...
    //function to check if the user input for phone has only numbers
        ...
        CheckoutLessons(){
                    if(this.errorMessage == "" && this.cart.length > 0){
                        ...
                        this.name = "";
                        this.phone = "";
                        this.props.cart.splice(0, this.cart.length);
                    }
